...
import 'package:voting_app/src/features/election/presentation/jobs_screen/jobs_screen_controller.dart';
import 'package:voting_app/src/routing/app_router.dart';
import 'package:voting_app/src/utils/async_value_ui.dart';

class ElecsScreen extends StatelessWidget {
  const ElecsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: const Text(Strings.myelec),
        actions: [
